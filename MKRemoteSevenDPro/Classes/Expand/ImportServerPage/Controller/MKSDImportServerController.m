...
@interface MKSDImportServerController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MKSDImportServerController

- (void)dealloc {
    NSLog(@"MKSDImportServerController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(sd_selectedServerParams:)]) {
        [self.delegate sd_selectedServerParams:model.leftMsg];
    }
