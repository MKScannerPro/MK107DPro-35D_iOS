...
@implementation MKSDAlertViewModel
@end

@interface MKSDAlertView ()
...
@implementation MKSDAlertView

- (void)dealloc {
    NSLog(@"MKSDAlertView销毁");
}
...
- (void)showWithModel:(MKSDAlertViewModel *)dataModel
    ...
    if (!dataModel || ![dataModel isKindOfClass:MKSDAlertViewModel.class]) {
        return;
    }
