...
@implementation MKSDSettingModel
...
- (BOOL)readOutputSwitch {
    ...
    [MKSDMQTTInterface sd_readOutputSwitchWithMacAddress:[MKSDDeviceModeManager shared].macAddress topic:[MKSDDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readOutputControlByButton {
    __block BOOL success = NO;
    [MKSDMQTTInterface sd_readOutputControlByButtonWithMacAddress:[MKSDDeviceModeManager shared].macAddress topic:[MKSDDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
