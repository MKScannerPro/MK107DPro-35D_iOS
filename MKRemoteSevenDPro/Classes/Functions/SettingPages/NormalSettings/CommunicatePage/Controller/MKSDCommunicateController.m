...
@interface MKSDCommunicateController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKSDCommunicateModel *dataModel;

@end

@implementation MKSDCommunicateController

- (void)dealloc {
    NSLog(@"MKSDCommunicateController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKRemoteSevenDPro", @"MKSDCommunicateController", @"sd_saveIcon.png") forState:UIControlStateNormal];
...
- (MKSDCommunicateModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKSDCommunicateModel alloc] init];
    }
    return _dataModel;
}
