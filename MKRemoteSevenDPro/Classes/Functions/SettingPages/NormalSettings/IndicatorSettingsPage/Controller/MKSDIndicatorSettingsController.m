//
//  MKSDIndicatorSettingsController.m
...
@interface MKSDIndicatorSettingsController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKSDIndicatorSetingsModel *dataModel;

@end

@implementation MKSDIndicatorSettingsController

- (void)dealloc {
    NSLog(@"MKSDIndicatorSettingsController销毁");
}
...
- (void)loadSectionDatas {
    ...
    cellModel5.index = 4;
    cellModel5.msg = @"Power LED";
    cellModel5.isOn = self.dataModel.power_led;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKRemoteSevenDPro", @"MKSDIndicatorSettingsController", @"sd_saveIcon.png") forState:UIControlStateNormal];
...
- (MKSDIndicatorSetingsModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKSDIndicatorSetingsModel alloc] init];
    }
    return _dataModel;
}
