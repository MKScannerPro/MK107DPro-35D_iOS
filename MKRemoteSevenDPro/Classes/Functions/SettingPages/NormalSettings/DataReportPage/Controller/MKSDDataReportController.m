...
@interface MKSDDataReportController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKSDDataReportModel *dataModel;

@end

@implementation MKSDDataReportController

- (void)dealloc {
    NSLog(@"MKSDDataReportController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKRemoteSevenDPro", @"MKSDDataReportController", @"sd_saveIcon.png") forState:UIControlStateNormal];
...
- (MKSDDataReportModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKSDDataReportModel alloc] init];
    }
    return _dataModel;
}
