...
@interface MKSDNetworkStatusController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKSDNetworkStatusModel *dataModel;

@end

@implementation MKSDNetworkStatusController

- (void)dealloc {
    NSLog(@"MKSDNetworkStatusController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKRemoteSevenDPro", @"MKSDNetworkStatusController", @"sd_saveIcon.png") forState:UIControlStateNormal];
...
- (MKSDNetworkStatusModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKSDNetworkStatusModel alloc] init];
    }
    return _dataModel;
}
