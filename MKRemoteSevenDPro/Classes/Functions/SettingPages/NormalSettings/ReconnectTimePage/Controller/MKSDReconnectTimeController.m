...
@interface MKSDReconnectTimeController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKSDReconnectTimeModel *dataModel;

@end

@implementation MKSDReconnectTimeController

- (void)dealloc {
    NSLog(@"MKSDReconnectTimeController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKRemoteSevenDPro", @"MKSDReconnectTimeController", @"sd_saveIcon.png") forState:UIControlStateNormal];
...
- (MKSDReconnectTimeModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKSDReconnectTimeModel alloc] init];
    }
    return _dataModel;
}
