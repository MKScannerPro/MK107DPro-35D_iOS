//
//  MKSDMqttServerConfigFooterView.h
...
@interface MKSDMqttServerConfigFooterViewModel : NSObject
...
@protocol MKSDMqttServerConfigFooterViewDelegate <NSObject>
...
@interface MKSDMqttServerConfigFooterView : UIView

@property (nonatomic, strong)MKSDMqttServerConfigFooterViewModel *dataModel;

@property (nonatomic, weak)id <MKSDMqttServerConfigFooterViewDelegate>delegate;
