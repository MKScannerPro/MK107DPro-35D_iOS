...
@implementation MKSDMqttServerLwtViewModel
@end

@interface MKSDMqttServerLwtView ()
...
@implementation MKSDMqttServerLwtView
...
- (void)lwtButtonPressed {
    ...
    UIImage *lwtIcon = (self.lwtButton.selected ? LOADICON(@"MKRemoteSevenDPro", @"MKSDMqttServerLwtView", @"sd_switchSelectedIcon.png") : LOADICON(@"MKRemoteSevenDPro", @"MKSDMqttServerLwtView", @"sd_switchUnselectedIcon.png"));
...
- (void)retainButtonPressed {
    ...
    UIImage *retainIcon = (self.retainButton.selected ? LOADICON(@"MKRemoteSevenDPro", @"MKSDMqttServerLwtView", @"sd_switchSelectedIcon.png") : LOADICON(@"MKRemoteSevenDPro", @"MKSDMqttServerLwtView", @"sd_switchUnselectedIcon.png"));
...
#pragma mark - setter
- (void)setDataModel:(MKSDMqttServerLwtViewModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKSDMqttServerLwtViewModel.class]) {
        return;
    }
...
- (UIButton *)lwtButton {
    if (!_lwtButton) {
        ...
        [_lwtButton setImage:LOADICON(@"MKRemoteSevenDPro", @"MKSDMqttServerLwtView", @"sd_switchUnselectedIcon.png") forState:UIControlStateNormal];
...
- (UIButton *)retainButton {
    if (!_retainButton) {
        ...
        [_retainButton setImage:LOADICON(@"MKRemoteSevenDPro", @"MKSDMqttServerLwtView", @"sd_switchUnselectedIcon.png") forState:UIControlStateNormal];
