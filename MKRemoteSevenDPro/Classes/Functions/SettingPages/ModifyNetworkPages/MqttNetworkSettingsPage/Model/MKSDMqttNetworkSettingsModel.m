//
//  MKSDMqttNetworkSettingsModel.m
...
@interface MKSDMqttNetworkSettingsModel ()
...
@implementation MKSDMqttNetworkSettingsModel
...
- (BOOL)readNetworkInfos {
    ...
    [MKSDMQTTInterface sd_readNetworkInfosWithMacAddress:[MKSDDeviceModeManager shared].macAddress topic:[MKSDDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configNetworkInfos {
    __block BOOL success = NO;
    [MKSDMQTTInterface sd_modifyNetworkInfos:self macAddress:[MKSDDeviceModeManager shared].macAddress topic:[MKSDDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
