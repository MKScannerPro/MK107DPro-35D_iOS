//
//  MKSDMqttNetworkSettingsController.m
...
@interface MKSDMqttNetworkSettingsController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKSDMqttNetworkSettingsModel *dataModel;

@end

@implementation MKSDMqttNetworkSettingsController

- (void)dealloc {
    NSLog(@"MKSDMqttNetworkSettingsController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKRemoteSevenDPro", @"MKSDMqttNetworkSettingsController", @"sd_saveIcon.png") forState:UIControlStateNormal];
...
- (MKSDMqttNetworkSettingsModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKSDMqttNetworkSettingsModel alloc] init];
    }
    return _dataModel;
}
