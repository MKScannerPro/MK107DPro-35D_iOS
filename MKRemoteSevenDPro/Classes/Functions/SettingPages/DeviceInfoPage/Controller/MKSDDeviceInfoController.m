...
@interface MKSDDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKSDDeviceInfoModel *dataModel;

@end

@implementation MKSDDeviceInfoController

- (void)dealloc {
    NSLog(@"MKSDDeviceInfoController销毁");
}
...
- (void)loadSectionDatas {
    ...
    cellModel8.rightMsg = self.dataModel.bleVersion;
...
- (MKSDDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKSDDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
