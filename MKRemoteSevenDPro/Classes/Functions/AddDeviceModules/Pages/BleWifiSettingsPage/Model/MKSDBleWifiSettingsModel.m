...
@interface MKSDBleWifiSettingsModel ()
...
@implementation MKSDBleWifiSettingsModel
...
- (void)readDataWithSucBlock:(void (^)(void))sucBlock failedBlock:(void (^)(NSError *error))failedBlock {
    dispatch_async(self.readQueue, ^{
        ...
        if (![self readCountryBand]) {
            [self operationFailedBlockWithMsg:@"Read Country Band Server Error" block:failedBlock];
            return;
        }
...
- (BOOL)readSecurityType {
    ...
    [MKSDInterface sd_readWIFISecurityWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configSecurityType {
    __block BOOL success = NO;
    [MKSDInterface sd_configWIFISecurity:self.security sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readWifiSSID {
    __block BOOL success = NO;
    [MKSDInterface sd_readWIFISSIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configWifiSSID {
    __block BOOL success = NO;
    [MKSDInterface sd_configWIFISSID:self.ssid sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readWifiPassword {
    __block BOOL success = NO;
    [MKSDInterface sd_readWIFIPasswordWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configWifiPassword {
    __block BOOL success = NO;
    [MKSDInterface sd_configWIFIPassword:self.wifiPassword sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readEAPType {
    __block BOOL success = NO;
    [MKSDInterface sd_readWIFIEAPTypeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configEAPType {
    __block BOOL success = NO;
    [MKSDInterface sd_configWIFIEAPType:self.eapType sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readEAPUsername {
    __block BOOL success = NO;
    [MKSDInterface sd_readWIFIEAPUsernameWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configEAPUsername {
    __block BOOL success = NO;
    [MKSDInterface sd_configWIFIEAPUsername:self.eapUserName sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readEAPPassword {
    __block BOOL success = NO;
    [MKSDInterface sd_readWIFIEAPPasswordWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configEAPPassword {
    __block BOOL success = NO;
    [MKSDInterface sd_configWIFIEAPPassword:self.eapPassword sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readEAPDomainID {
    __block BOOL success = NO;
    [MKSDInterface sd_readWIFIEAPDomainIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configEAPDomainID {
    __block BOOL success = NO;
    [MKSDInterface sd_configWIFIEAPDomainID:self.domainID sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readVerifyServer {
    __block BOOL success = NO;
    [MKSDInterface sd_readWIFIVerifyServerStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configVerifyServer {
    __block BOOL success = NO;
    [MKSDInterface sd_configWIFIVerifyServerStatus:self.verifyServer sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configCAFile {
    ...
    [MKSDInterface sd_configWIFICAFile:caData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configClientKey {
    ...
    [MKSDInterface sd_configWIFIClientPrivateKey:clientKeyData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configClientCert {
    ...
    [MKSDInterface sd_configWIFIClientCert:clientCertData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readCountryBand {
    __block BOOL success = NO;
    [MKSDInterface sd_readCountryBandWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configCountryBand {
    __block BOOL success = NO;
    [MKSDInterface sd_configCountryBand:self.country sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configDate {
    ...
    [MKSDInterface sd_configDeviceTime:recordTime sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
