...
@interface MKSDServerForDeviceModel ()
...
@implementation MKSDServerForDeviceModel
...
- (void)updateValue:(MKSDServerForDeviceModel *)model {
    if (!model || ![model isKindOfClass:MKSDServerForDeviceModel.class]) {
        return;
    }
...
- (BOOL)readDeviceMac {
    ...
    [MKSDInterface sd_readDeviceWifiSTAMacAddressWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readDeviceName {
    __block BOOL success = NO;
    [MKSDInterface sd_readDeviceNameWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readHost {
    __block BOOL success = NO;
    [MKSDInterface sd_readServerHostWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configHost {
    __block BOOL success = NO;
    [MKSDInterface sd_configServerHost:self.host sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readPort {
    __block BOOL success = NO;
    [MKSDInterface sd_readServerPortWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configPort {
    __block BOOL success = NO;
    [MKSDInterface sd_configServerPort:[self.port integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readClientID {
    __block BOOL success = NO;
    [MKSDInterface sd_readClientIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configClientID {
    __block BOOL success = NO;
    [MKSDInterface sd_configClientID:self.clientID sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readUsername {
    __block BOOL success = NO;
    [MKSDInterface sd_readServerUserNameWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configUserName {
    __block BOOL success = NO;
    [MKSDInterface sd_configServerUserName:self.userName sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readPassword {
    __block BOOL success = NO;
    [MKSDInterface sd_readServerPasswordWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configPassword {
    __block BOOL success = NO;
    [MKSDInterface sd_configServerPassword:self.password sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readCleanSession {
    __block BOOL success = NO;
    [MKSDInterface sd_readServerCleanSessionWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configCleanSession {
    __block BOOL success = NO;
    [MKSDInterface sd_configServerCleanSession:self.cleanSession sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readKeepAlive {
    __block BOOL success = NO;
    [MKSDInterface sd_readServerKeepAliveWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configKeepAlive {
    __block BOOL success = NO;
    [MKSDInterface sd_configServerKeepAlive:[self.keepAlive integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readQos {
    __block BOOL success = NO;
    [MKSDInterface sd_readServerQosWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configQos {
    __block BOOL success = NO;
    [MKSDInterface sd_configServerQos:self.qos sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readSubscribe {
    __block BOOL success = NO;
    [MKSDInterface sd_readSubscibeTopicWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configSubscribe {
    ...
    [MKSDInterface sd_configSubscibeTopic:topic sucBlock:^{
        success = YES;
...
- (BOOL)readPublish {
    __block BOOL success = NO;
    [MKSDInterface sd_readPublishTopicWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configPublish {
    ...
    [MKSDInterface sd_configPublishTopic:topic sucBlock:^{
        success = YES;
...
- (BOOL)readLWTStatus {
    __block BOOL success = NO;
    [MKSDInterface sd_readLWTStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configLWTStatus {
    __block BOOL success = NO;
    [MKSDInterface sd_configLWTStatus:self.lwtStatus sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readLWTQos {
    __block BOOL success = NO;
    [MKSDInterface sd_readLWTQosWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configLWTQos {
    __block BOOL success = NO;
    [MKSDInterface sd_configLWTQos:self.lwtQos sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readLWTRetain {
    __block BOOL success = NO;
    [MKSDInterface sd_readLWTRetainWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configLWTRetain {
    __block BOOL success = NO;
    [MKSDInterface sd_configLWTRetain:self.lwtRetain sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readLWTTopic {
    __block BOOL success = NO;
    [MKSDInterface sd_readLWTTopicWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configLWTTopic {
    ...
    [MKSDInterface sd_configLWTTopic:topic sucBlock:^{
        success = YES;
        self.lwtTopic = topic;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
...
- (BOOL)readLWTPayload {
    __block BOOL success = NO;
    [MKSDInterface sd_readLWTPayloadWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configLWTPayload {
    __block BOOL success = NO;
    [MKSDInterface sd_configLWTPayload:self.lwtPayload sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readSSLStatus {
    __block BOOL success = NO;
    [MKSDInterface sd_readConnectModeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configSSLStatus {
    __block BOOL success = NO;
    mk_sd_connectMode mode = mk_sd_connectMode_TCP;
    if (self.sslIsOn) {
        if (self.certificate == 0) {
            mode = mk_sd_connectMode_CASignedServerCertificate;
        }else if (self.certificate == 1) {
            mode = mk_sd_connectMode_CACertificate;
        }else if (self.certificate == 2) {
            mode = mk_sd_connectMode_SelfSignedCertificates;
        }
    }
    [MKSDInterface sd_configConnectMode:mode sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configCAFile {
    ...
    [MKSDInterface sd_configCAFile:caData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configClientKey {
    ...
    [MKSDInterface sd_configClientPrivateKey:clientKeyData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configClientCert {
    ...
    [MKSDInterface sd_configClientCert:clientCertData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
