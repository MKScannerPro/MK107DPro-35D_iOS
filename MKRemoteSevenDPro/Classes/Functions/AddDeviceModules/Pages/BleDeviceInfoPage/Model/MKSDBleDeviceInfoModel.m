...
@interface MKSDBleDeviceInfoModel ()
...
@implementation MKSDBleDeviceInfoModel
...
- (BOOL)readDeviceModel {
    __block BOOL success = NO;
    [MKSDInterface sd_readDeviceModelWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readSoftware {
    __block BOOL success = NO;
    [MKSDInterface sd_readSoftwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readFirmware {
    __block BOOL success = NO;
    [MKSDInterface sd_readFirmwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readHardware {
    __block BOOL success = NO;
    [MKSDInterface sd_readHardwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readManu {
    __block BOOL success = NO;
    [MKSDInterface sd_readManufacturerWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readMacAddress {
    __block BOOL success = NO;
    [MKSDInterface sd_readMacAddressWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
