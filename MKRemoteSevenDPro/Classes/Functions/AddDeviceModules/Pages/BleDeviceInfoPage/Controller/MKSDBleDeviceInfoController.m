...
@interface MKSDBleDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKSDBleDeviceInfoModel *dataModel;

@end

@implementation MKSDBleDeviceInfoController

- (void)dealloc {
    NSLog(@"MKSDBleDeviceInfoController销毁");
...
- (MKSDBleDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKSDBleDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
