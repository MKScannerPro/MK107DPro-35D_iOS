//
//  MKSDBleNetworkSettingsController.m
...
@interface MKSDBleNetworkSettingsController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKSDBleNetworkSettingsModel *dataModel;

@end

@implementation MKSDBleNetworkSettingsController

- (void)dealloc {
    NSLog(@"MKSDBleNetworkSettingsController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKRemoteSevenDPro", @"MKSDBleNetworkSettingsController", @"sd_saveIcon.png") forState:UIControlStateNormal];
...
- (MKSDBleNetworkSettingsModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKSDBleNetworkSettingsModel alloc] init];
    }
    return _dataModel;
}
