//
//  MKSDBleScannerFilterController.m
...
@interface MKSDBleScannerFilterController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKSDBleScannerFilterModel *dataModel;

@end

@implementation MKSDBleScannerFilterController

- (void)dealloc {
    NSLog(@"MKSDBleScannerFilterController销毁");
}
...
- (void)mk_sd_filterNormalTextFieldValueChanged:(NSString *)text index:(NSInteger)index {
    ...
    if (index == 1) {
        ...
        MKSDFilterNormalTextFieldCellModel *cellModel = self.section1List[1];
        cellModel.textFieldValue = text;
        return;
    }
}
...
- (void)loadSection1Datas {
    MKSDFilterNormalTextFieldCellModel *cellModel1 = [[MKSDFilterNormalTextFieldCellModel alloc] init];
    cellModel1.index = 0;
    ...
    MKSDFilterNormalTextFieldCellModel *cellModel2 = [[MKSDFilterNormalTextFieldCellModel alloc] init];
    cellModel2.index = 1;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKRemoteSevenDPro", @"MKSDBleScannerFilterController", @"sd_saveIcon.png") forState:UIControlStateNormal];
...
- (MKSDBleScannerFilterModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKSDBleScannerFilterModel alloc] init];
    }
    return _dataModel;
}
