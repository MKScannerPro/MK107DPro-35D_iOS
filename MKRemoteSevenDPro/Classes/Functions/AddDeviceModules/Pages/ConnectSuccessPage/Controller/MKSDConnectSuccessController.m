//
//  MKSDConnectSuccessController.m
...
@interface MKSDConnectSuccessController ()
...
@implementation MKSDConnectSuccessController

- (void)dealloc {
    NSLog(@"MKSDConnectSuccessController销毁");
}
...
- (void)saveButtonPressed {
    ...
    [MKSDDeviceDatabaseManager insertDeviceList:@[self.deviceModel] sucBlock:^{
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_sd_addNewDeviceSuccessNotification"
                                                            object:nil
