...
@implementation MKSDAddDeviceView
...
- (UIImageView *)centerIcon{
    if (!_centerIcon) {
        ...
        _centerIcon.image = LOADICON(@"MKRemoteSevenDPro", @"MKSDAddDeviceView", @"sd_deviceList_centerIcon.png");
    }
    return _centerIcon;
}
