...
@implementation MKSDReminderAlertViewModel
@end

@interface MKSDReminderColorButton : UIControl
...
@implementation MKSDReminderColorButton
...
- (UIImageView *)icon {
    if (!_icon) {
        ...
        _icon.image = LOADICON(@"MKRemoteSevenDPro", @"MKSDReminderColorButton", @"sd_resetByButtonUnselectedIcon.png");
    }
    return _icon;
}
...
@interface MKSDReminderAlertView ()
...
@property (nonatomic, strong)MKSDReminderColorButton *redColor;

@property (nonatomic, strong)MKSDReminderColorButton *blueColor;

@property (nonatomic, strong)MKSDReminderColorButton *greenColor;

@end

@implementation MKSDReminderAlertView
...
- (void)setupColorIcons {
    self.redColor.icon.image = (self.currentColor == 0 ? LOADICON(@"MKRemoteSevenDPro", @"MKSDReminderColorButton", @"sd_resetByButtonSelectedIcon.png") : LOADICON(@"MKRemoteSevenDPro", @"MKSDReminderColorButton", @"sd_resetByButtonUnselectedIcon.png"));
    self.blueColor.icon.image = (self.currentColor == 1 ? LOADICON(@"MKRemoteSevenDPro", @"MKSDReminderColorButton", @"sd_resetByButtonSelectedIcon.png") : LOADICON(@"MKRemoteSevenDPro", @"MKSDReminderColorButton", @"sd_resetByButtonUnselectedIcon.png"));
    self.greenColor.icon.image = (self.currentColor == 2 ? LOADICON(@"MKRemoteSevenDPro", @"MKSDReminderColorButton", @"sd_resetByButtonSelectedIcon.png") : LOADICON(@"MKRemoteSevenDPro", @"MKSDReminderColorButton", @"sd_resetByButtonUnselectedIcon.png"));
}
...
- (MKSDReminderColorButton *)redColor {
    if (!_redColor) {
        _redColor = [[MKSDReminderColorButton alloc] init];
...
- (MKSDReminderColorButton *)blueColor {
    if (!_blueColor) {
        _blueColor = [[MKSDReminderColorButton alloc] init];
...
- (MKSDReminderColorButton *)greenColor {
    if (!_greenColor) {
        _greenColor = [[MKSDReminderColorButton alloc] init];
