//
//  MKSDConnectedDeviceWriteAlertView.m
...
@interface MKSDConnectedDeviceWriteAlertView ()
...
@implementation MKSDConnectedDeviceWriteAlertView

- (void)dealloc {
    NSLog(@"MKSDConnectedDeviceWriteAlertView销毁");
}
