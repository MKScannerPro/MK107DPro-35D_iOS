//
//  MKSDManageBleDeviceSearchView.m
...
@interface MKSDManageBleDeviceSearchView ()<UIGestureRecognizerDelegate>
...
@implementation MKSDManageBleDeviceSearchView

- (void)dealloc{
    NSLog(@"MKSDManageBleDeviceSearchView销毁");
}
...
+ (void)showSearchName:(NSString *)name
    ...
    MKSDManageBleDeviceSearchView *view = [[MKSDManageBleDeviceSearchView alloc] init];
...
- (UIImageView *)signalIcon{
    if (!_signalIcon) {
        _signalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(offset_X,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _signalIcon.image = LOADICON(@"MKRemoteSevenDPro", @"MKSDManageBleDeviceSearchView", @"sd_wifiSignalIcon.png");
    }
    return _signalIcon;
}
...
- (UIImageView *)graySignalIcon {
    if (!_graySignalIcon) {
        _graySignalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(backViewWidth - offset_X - signalIconWidth,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _graySignalIcon.image = LOADICON(@"MKRemoteSevenDPro", @"MKSDManageBleDeviceSearchView", @"sd_wifiGraySignalIcon.png");
    }
