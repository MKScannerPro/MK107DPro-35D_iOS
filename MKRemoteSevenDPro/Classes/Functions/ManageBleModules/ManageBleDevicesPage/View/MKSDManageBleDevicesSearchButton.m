//
//  MKSDManageBleDevicesSearchButton.m
...
@implementation MKSDManageBleDevicesSearchButtonModel
@end

@interface MKSDManageBleDevicesSearchButton ()
...
@implementation MKSDManageBleDevicesSearchButton
...
- (void)clearButtonPressed{
    ...
    if ([self.delegate respondsToSelector:@selector(sd_scanSearchButtonClearMethod)]) {
        [self.delegate sd_scanSearchButtonClearMethod];
    }
}

- (void)searchButtonPressed{
    if ([self.delegate respondsToSelector:@selector(sd_scanSearchButtonMethod)]) {
        [self.delegate sd_scanSearchButtonMethod];
    }
}

#pragma mark - setting
- (void)setDataModel:(MKSDManageBleDevicesSearchButtonModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKSDManageBleDevicesSearchButtonModel.class]) {
        return;
    }
...
- (UIImageView *)searchIcon{
    if (!_searchIcon) {
        ...
        _searchIcon.image = LOADICON(@"MKRemoteSevenDPro", @"MKSDManageBleDevicesSearchButton", @"sd_searchGrayIcon.png");
    }
    return _searchIcon;
}
...
- (UIButton *)clearButton{
    if (!_clearButton) {
        ...
        [_clearButton setImage:LOADICON(@"MKRemoteSevenDPro", @"MKSDManageBleDevicesSearchButton", @"sd_clearButtonIcon.png") forState:UIControlStateNormal];
