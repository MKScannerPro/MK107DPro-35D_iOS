...
- (void)syncButtonPressed {
    ...
    [[MKNormalService share] addScannerProDevicesToCloud:uploadList isHome:[MKSDUserLoginManager shared].isHome token:self.token sucBlock:^(id returnData) {
