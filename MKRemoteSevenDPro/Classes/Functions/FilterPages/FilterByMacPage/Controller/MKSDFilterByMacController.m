...
@property (nonatomic, strong)MKSDFilterByMacModel *dataModel;

@end

@implementation MKSDFilterByMacController
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKRemoteSevenDPro", @"MKSDFilterByMacController", @"sd_saveIcon.png") forState:UIControlStateNormal];
...
- (MKSDFilterByMacModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKSDFilterByMacModel alloc] init];
    }
    return _dataModel;
}
