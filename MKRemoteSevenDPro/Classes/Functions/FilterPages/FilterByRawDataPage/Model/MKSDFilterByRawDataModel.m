...
@interface MKSDFilterByRawDataModel ()
...
@implementation MKSDFilterByRawDataModel
...
- (BOOL)readFilterByRawData {
    ...
    [MKSDMQTTInterface sd_readFilterByRawDataStatusWithMacAddress:[MKSDDeviceModeManager shared].macAddress topic:[MKSDDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
