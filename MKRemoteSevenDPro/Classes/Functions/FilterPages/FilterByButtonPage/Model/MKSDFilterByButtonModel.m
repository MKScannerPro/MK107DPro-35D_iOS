...
@interface MKSDFilterByButtonModel ()
...
@implementation MKSDFilterByButtonModel
...
- (BOOL)readFilterByBXPButton {
    ...
    [MKSDMQTTInterface sd_readFilterBXPButtonWithMacAddress:[MKSDDeviceModeManager shared].macAddress topic:[MKSDDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configFilterByBXPButton {
    __block BOOL success = NO;
    [MKSDMQTTInterface sd_configFilterBXPButton:self macAddress:[MKSDDeviceModeManager shared].macAddress topic:[MKSDDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
