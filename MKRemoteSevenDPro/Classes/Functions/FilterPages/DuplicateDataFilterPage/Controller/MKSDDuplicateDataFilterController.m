//
//  MKSDDuplicateDataFilterController.m
...
@interface MKSDDuplicateDataFilterController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKSDDuplicateDataFilterModel *dataModel;

@end

@implementation MKSDDuplicateDataFilterController

- (void)dealloc {
    NSLog(@"MKSDDuplicateDataFilterController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKRemoteSevenDPro", @"MKSDDuplicateDataFilterController", @"sd_saveIcon.png") forState:UIControlStateNormal];
...
- (MKSDDuplicateDataFilterModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKSDDuplicateDataFilterModel alloc] init];
    }
    return _dataModel;
}
