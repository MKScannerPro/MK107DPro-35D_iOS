//
//  MKSDUploadDataOptionController.m
...
@interface MKSDUploadDataOptionController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKSDUploadDataOptionModel *dataModel;

@end

@implementation MKSDUploadDataOptionController

- (void)dealloc {
    NSLog(@"MKSDUploadDataOptionController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKRemoteSevenDPro", @"MKSDUploadDataOptionController", @"sd_saveIcon.png") forState:UIControlStateNormal];
...
- (MKSDUploadDataOptionModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKSDUploadDataOptionModel alloc] init];
    }
    return _dataModel;
}
