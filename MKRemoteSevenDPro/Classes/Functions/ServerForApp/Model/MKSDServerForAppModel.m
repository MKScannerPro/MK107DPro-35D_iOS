...
@implementation MKSDServerForAppModel
...
- (void)updateValue:(MKSDServerForAppModel *)model {
    if (!model || ![model isKindOfClass:MKSDServerForAppModel.class]) {
        return;
    }
...
- (void)loadServerParams {
    ...
    self.host = [MKSDMQTTDataManager shared].serverParams.host;
    self.port = [MKSDMQTTDataManager shared].serverParams.port;
    self.clientID = [MKSDMQTTDataManager shared].serverParams.clientID;
    self.subscribeTopic = [MKSDMQTTDataManager shared].serverParams.subscribeTopic;
    self.publishTopic = [MKSDMQTTDataManager shared].serverParams.publishTopic;
    self.cleanSession = [MKSDMQTTDataManager shared].serverParams.cleanSession;
    
    self.qos = [MKSDMQTTDataManager shared].serverParams.qos;
    self.keepAlive = [MKSDMQTTDataManager shared].serverParams.keepAlive;
    self.userName = [MKSDMQTTDataManager shared].serverParams.userName;
    self.password = [MKSDMQTTDataManager shared].serverParams.password;
    self.sslIsOn = [MKSDMQTTDataManager shared].serverParams.sslIsOn;
    self.certificate = [MKSDMQTTDataManager shared].serverParams.certificate;
    self.caFileName = [MKSDMQTTDataManager shared].serverParams.caFileName;
    self.clientFileName = [MKSDMQTTDataManager shared].serverParams.clientFileName;
}
