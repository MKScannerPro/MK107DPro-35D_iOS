...
extern NSString *const mk_sd_peripheralConnectStateChangedNotification;

//Notification of changes in the status of the Bluetooth Center.
extern NSString *const mk_sd_centralManagerStateChangedNotification;
 ...
 */
extern NSString *const mk_sd_deviceDisconnectTypeNotification;

@class CBCentralManager,CBPeripheral;
@class MKSDOperation;

@interface MKSDCentralManager : NSObject<MKBLEBaseCentralManagerProtocol>

@property (nonatomic, weak)id <mk_sd_centralManagerScanDelegate>delegate;

/// Current connection status
@property (nonatomic, assign, readonly)mk_sd_centralConnectStatus connectStatus;

+ (MKSDCentralManager *)shared;
...
- (mk_sd_centralManagerStatus )centralStatus;
...
- (void)addTaskWithTaskID:(mk_sd_taskOperationID)operationID
...
/// @param successBlock Successful callback
/// @param failureBlock Failure callback
- (void)addReadTaskWithTaskID:(mk_sd_taskOperationID)operationID
               characteristic:(CBCharacteristic *)characteristic
                 successBlock:(void (^)(id returnData))successBlock
                 failureBlock:(void (^)(NSError *error))failureBlock;

- (void)addOperation:(MKSDOperation *)operation;
