...
@interface MKSDPeripheral ()

@property (nonatomic, strong)CBPeripheral *peripheral;

@end

@implementation MKSDPeripheral
...
- (void)updateCharacterWithService:(CBService *)service {
    [self.peripheral sd_updateCharacterWithService:service];
}

- (void)updateCurrentNotifySuccess:(CBCharacteristic *)characteristic {
    [self.peripheral sd_updateCurrentNotifySuccess:characteristic];
}

- (BOOL)connectSuccess {
    return [self.peripheral sd_connectSuccess];
}

- (void)setNil {
    [self.peripheral sd_setNil];
}
