...
/**
 线程ID
 */
@property (nonatomic, assign)mk_sd_serverOperationID operationID;
...
@implementation MKSDMQTTOperation
@synthesize executing = _executing;
@synthesize finished = _finished;

- (void)dealloc{
    NSLog(@"MKSDMQTTOperation销毁");
}
...
#pragma mark - MKSDMQTTOperationProtocol
...
- (void)didReceiveMessage:(NSDictionary *)data onTopic:(NSString *)topic {
    ...
    [self dataParserReceivedData:[MKSDMQTTTaskAdopter parseDataWithJson:data topic:topic]];
}
...
- (void)dataParserReceivedData:(NSDictionary *)dataDic{
    ...
    mk_sd_serverOperationID operationID = [dataDic[@"operationID"] integerValue];
    if (operationID == mk_sd_defaultServerOperationID || operationID != self.operationID) {
        return;
    }
