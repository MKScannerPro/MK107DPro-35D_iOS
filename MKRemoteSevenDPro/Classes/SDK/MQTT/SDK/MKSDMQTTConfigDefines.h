...
typedef NS_ENUM(NSInteger, mk_sd_keyResetType) {
    mk_sd_keyResetType_powerOnOneMin,     //Press in 1 min after powered
    mk_sd_keyResetType_pressAnyTime,      //Press any time
};
...
typedef NS_ENUM(NSInteger, mk_sd_filterRelationship) {
    ...
    mk_sd_filterRelationship_advNameAndRawDataAndMac,
    mk_sd_filterRelationship_advNameOrRawData,
    mk_sd_filterRelationship_advNameAndRawMac,
};

typedef NS_ENUM(NSInteger, mk_sd_filterByTLM) {
    mk_sd_filterByTLM_nonEncrypted,        //Non-encrypted type TLM
    mk_sd_filterByTLM_encrypted,           //Encryption type TLM
    mk_sd_filterByTLM_all,                //Filter all Eddystone_TLM data
};

typedef NS_ENUM(NSInteger, mk_sd_filterByOther) {
    mk_sd_filterByOther_A,                 //Filter by A condition.
    mk_sd_filterByOther_AB,                //Filter by A & B condition.
    mk_sd_filterByOther_AOrB,              //Filter by A | B condition.
    mk_sd_filterByOther_ABC,               //Filter by A & B & C condition.
    mk_sd_filterByOther_ABOrC,             //Filter by (A & B) | C condition.
    mk_sd_filterByOther_AOrBOrC,           //Filter by A | B | C condition.
};

typedef NS_ENUM(NSInteger, mk_sd_duplicateDataFilter) {
    mk_sd_duplicateDataFilter_none,
    mk_sd_duplicateDataFilter_mac,
    mk_sd_duplicateDataFilter_macAndDataType,
    mk_sd_duplicateDataFilter_macAndRawData
};

typedef NS_ENUM(NSInteger, mk_sd_PHYMode) {
...
@protocol sd_indicatorLightStatusProtocol <NSObject>
...
@protocol mk_sd_BLEFilterRawDataProtocol <NSObject>
...
@protocol mk_sd_BLEFilterBXPButtonProtocol <NSObject>
...
@protocol mk_sd_BLEFilterPirProtocol <NSObject>
...
@protocol mk_sd_mqttModifyWifiProtocol <NSObject>
...
@protocol mk_sd_mqttModifyWifiEapCertProtocol <NSObject>
...
@protocol mk_sd_mqttModifyNetworkProtocol <NSObject>
...
@protocol mk_sd_modifyMqttServerProtocol <NSObject>
...
@protocol mk_sd_modifyMqttServerCertsProtocol <NSObject>
...
@protocol sd_uploadDataOptionProtocol <NSObject>
...
@protocol sd_advertiseBeaconProtocol <NSObject>
