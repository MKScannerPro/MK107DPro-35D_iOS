...
static NSString *const fileName = @"MKSDServerParams.txt";

@interface MKSDServerParamsModel ()
...
@implementation MKSDServerParamsModel
...
- (BOOL)checkServerDataProtocol:(id <MKSDServerParamsProtocol>)protocol {
