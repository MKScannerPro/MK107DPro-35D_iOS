...
static MKSDUserLoginManager *loginManager = nil;
static dispatch_once_t onceToken;

@interface MKSDUserLoginManager ()
...
+ (MKSDUserLoginManager *)shared {
    dispatch_once(&onceToken, ^{
        if (!loginManager) {
            loginManager = [MKSDUserLoginManager new];
        }
    });
    return loginManager;
}
