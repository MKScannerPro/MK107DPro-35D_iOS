...
typedef NS_ENUM(NSInteger, MKSDDeviceModelState) {
    MKSDDeviceModelStateOffline,
    MKSDDeviceModelStateOnline,
};

//当设备离线的时候发出通知
extern NSString *const MKSDDeviceModelOfflineNotification;

@protocol MKSDDeviceModelDelegate <NSObject>
...
@interface MKSDDeviceModel : NSObject<MKSDDeviceModeManagerDataProtocol>
...
/**
 设备的状态，离线、在线
 */
@property (nonatomic, assign)MKSDDeviceModelState onLineState;

#pragma mark - 业务流程相关

@property (nonatomic, weak)id <MKSDDeviceModelDelegate>delegate;
